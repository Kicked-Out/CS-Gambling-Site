document.addEventListener("DOMContentLoaded", async function () {
  ...
  // getUSerBalance();
    ...
    async function createSkinElement(skinData) {
      ...
      skinDiv.innerHTML = `
        <img src="${skin.image}" alt="${skinData.name}" class="skin-img" style="z-index: 1;"/>
        <img src="${hexagon}" alt="${skinData.name}" width="64px" height="64px" style="position: absolute;" class="hexagone-img"/>
    ...
    async function spinAnimation() {
      ...
      const finalDuration = 700;   // уповільнення в кінці
